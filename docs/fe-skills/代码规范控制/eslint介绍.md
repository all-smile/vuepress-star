...
```javascript
/* eslint-disable */
在文件头部声明忽略某个文件的eslint检测
```

```javascript
// eslint-disable-next-line
或者在某一行js代码上添加忽略某一行代码的eslint检测
```
## 空格问题
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2932776/1653974769513-a03c1088-2940-44ac-ab26-4366dc780f2c.png#averageHue=%2393b9be&clientId=ubfaabbe6-9558-4&from=paste&height=238&id=uf404e46d&originHeight=297&originWidth=1050&originalType=binary&ratio=1&rotation=0&showTitle=false&size=64438&status=done&style=none&taskId=u92f69ad7-7537-4056-b90f-3a0d64d3c89&title=&width=840)
## eslintrc配置
```javascript
module.exports = {
  parser: 'babel-eslint',
...
```
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2932776/1653975015451-f1cdb5c2-675c-46a1-9c83-76ae199750ce.png#averageHue=%231d1b1a&clientId=u8bdf4155-0a39-4&from=paste&height=93&id=ua956c78b&originHeight=116&originWidth=675&originalType=binary&ratio=1&rotation=0&showTitle=false&size=15539&status=done&style=none&taskId=u5b474348-f094-4153-b4ca-4acf49532c8&title=&width=540)
## 忽略检测的文件
